odoo.define('pways_salon_and_spa_management.website_salon_booking', function (require) {
    'use strict';
        ...
        if (name == "" || date == "" || time == "" || phone == "" || email == "") {
            ...
            if (isNaN(time_left_char) || isNaN(time_right_char) || time_separator != ":") {
                ...
                if ((time_left < 24) && (time_right < 60) && (time_left >= 0) && (time_right >= 0)) {
                    var booking_record = {'name': name, 'date': date, 'time': time, 'phone': phone, 'email': email};
                    $.ajax({
                        ...
                        success: function( data ) {
                            window.location.href = "/page/pways_salon_and_spa_management/salon_booking_thank_you";
                        },
