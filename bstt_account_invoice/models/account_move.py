...
class AccountMove(models.Model):
    ...
    contract_ref_ar = fields.Text(string="Arabic Contract Ref.")
    contract_value_ar = fields.Text(string="Arabic Contract Value")
    reserved_note = fields.Char(string="Reserved Notes")
